...
export type CreateCampgroundMutation = {
  __typename?: "Mutation";
  createCampground: {
    __typename?: "Campground";
    id: number;
...
export function useCreateCampgroundMutation() {
  return Urql.useMutation<
    ...
    CreateCampgroundMutationVariables
  >(CreateCampgroundDocument);
}
...
export function useCampgroundsQuery(
  options: Omit<Urql.UseQueryArgs<CampgroundsQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<CampgroundsQuery>({
    query: CampgroundsDocument,
    ...options,
  });
}
